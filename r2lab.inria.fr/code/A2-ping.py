...
fit01 = ec.register_resource("linux::Node",
                             username = user01,
                             hostname = host01,
                             # to reach the fit01 node, we need to go through the gateway
                             # so let's assign the gateway infos
...
# creating an application to ping the control interface of fit01 node from the gateway
