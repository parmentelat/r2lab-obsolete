...
r2lab_user = {{r2lab_context.user_details|jsonify|safe}};
// shortcuts
r2lab_email = {{r2lab_context.user_details.email|jsonify|safe}};
r2lab_hrn = {{r2lab_context.user_details.hrn|jsonify|safe}};
