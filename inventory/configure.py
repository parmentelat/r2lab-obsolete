...
192.168.1.101   switch-reboot
192.168.1.102   switch-data
192.168.1.103   switch-control
...
### the 3 switches
# most likely the data switch
dhcp-host=net:control,d0:67:e5:d6:ae:fe,switch-data,192.168.1.102

# control or reboot ?
dhcp-host=net:control,f8:b1:56:42:51:32,switch-reboot,192.168.1.101

# control or reboot ?
dhcp-host=net:control,f8:b1:56:33:50:ad,switch-control,192.168.1.103
