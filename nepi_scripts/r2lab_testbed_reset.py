...
#
# $ cd <path-to-nepi>
# python examples/omg/r2lab_testbed_reset.py -H <fitXX,fitZZ,..> -u <r2lab-username> -i <ssh-key> -g <r2lab-gateway> -U <r2lab-gateway-username>
# python examples/omf/r2lab_testbed_reset.py -H fit12,fit18 -u root -i ~/.ssh -g faraday.inria.fr -U root
#
