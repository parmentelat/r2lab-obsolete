...
## INRIA testbed (R2Lab) before running a OMF experiment using
## Nitos nodes. 

# Example of how to run this experiment (replace with your information):
#
# $ cd <path-to-nepi>
# python examples/omg/r2lab_testbed_bootstrap.py -H <fitXX,fitZZ,..> -u <r2lab-username> -i <ssh-key> -g <r2lab-gateway> -U <r2lab-gateway-username>
# python examples/omf/r2lab_testbed_bootstrap.py -H fit12,fit18 -u root -i ~/.ssh -g faraday.inria.fr -U root
#
...
ec.set(gw_node, "cleanProcesses", True)
...
reboot_cmd = "omf6 stat -t %s" % hosts 
...
for hostname in hosts:
    ...
    ec.register_condition(node, ResourceAction.DEPLOY, reboot_app, 
            ResourceState.STOPPED, time="15s") 
    ping_cmd = "ping -c10 %s" % host
